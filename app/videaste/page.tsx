...
export default function VideastePage() {
  return (
    <div className="min-h-screen bg-off-white">
      ...
      {/* Hero */}
      <section className="min-h-0 sm:min-h-screen grid grid-cols-1 md:grid-cols-2 items-start sm:items-end px-4 sm:px-6 md:px-12 pt-[72px] sm:pt-20 pb-8 sm:pb-10 md:pb-16 bg-off-white border-b-[3px] border-black relative">
        <div>
          <p
