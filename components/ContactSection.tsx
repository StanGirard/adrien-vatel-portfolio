      ...
      >
        ...
        <div className="flex flex-col gap-2 items-start md:items-end w-full md:w-auto">
          <a
            ...
            className="contact-link inline-flex items-center gap-3 px-5 sm:px-7 py-4 sm:py-3.5 border-2 border-black font-mono text-[8px] sm:text-[9px] tracking-[0.15em] sm:tracking-[0.2em] no-underline transition-all w-full md:w-auto justify-center min-h-[44px]"
            onMouseEnter={(e) => {
